...
Tratativa de ocorrências (status, respostas prontas), dashboards/indicadores, exportação PDF/CSV, notificações em tempo real, gestão de usuários e QR Codes pelo admin.
